...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="profil_pegawai.css">
  </head>
  <body>
    <!--awal navbar-->
    ...
    <div class="container">
      <div class="card mx-auto" style="margin-top: 100px; width: 600px;">
        ...
        <div class="card-body" style="width: 600px;">
          ...
          <a href="/project-pweb/login_page/Pegawai/ubah_pegawai.php" class="btn float-end">ubah password</a>
          <form action="profil_pegawai.php" method="post">
